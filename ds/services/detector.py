...
def face_detect(frame, known_face_encodings, known_face_names):
...
def setup_mask_models(model_path: str, prototxt_path, weights_path):
...
def detect_and_predict_mask(frame, threshold_confidence=0.5):
    global faceNet, maskNet
